...
/* ============================================================
   ABC 蒙蒙學校 2.0 — 上課與挑戰分開的 MCTS 英文課（6 歲）
...
export default function App() {
  ...
  async function tapTeachCard() {
    ...
    await speakSeqAsync(it.kind === "dlg" ? [it.prompt, it.en] : [it.en]);
